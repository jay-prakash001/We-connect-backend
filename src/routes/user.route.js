...
import { createWorker, setUserDetails, logOut, get_user_details, get_worker_details, update_profileImg,get_user_profile } from "../controllers/user.controller.js";
...
router.route('/get_user_profile').get(verifyJwt,get_user_profile)
